// Stroke-based icons on a 24px grid, one consistent style. No icon library:
// this is a handful of glyphs, not worth a dependency.
...
export function MailIcon({ size = 17, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function DownloadIcon({ size = 17, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GithubIcon({ size = 20, className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M9 19c-4 1.4-4-2.2-5.6-2.7M15 21v-3.6a3 3 0 0 0-.9-2.4c2.9-.3 6-1.5 6-6.5a5 5 0 0 0-1.4-3.5 4.7 4.7 0 0 0-.1-3.5s-1.1-.3-3.6 1.4a12.3 12.3 0 0 0-6.5 0C6 1.2 4.9 1.5 4.9 1.5a4.7 4.7 0 0 0-.1 3.5A5 5 0 0 0 3.4 8.5c0 5 3.1 6.2 6 6.5a3 3 0 0 0-.9 2.3V21" />
    </svg>
  );
}
